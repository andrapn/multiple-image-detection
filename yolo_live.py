...
net = cv2.dnn.readNet("yolov3-tiny_training_last.weights", "yolov3-tiny_testing.cfg")
classes = []
...
# Load Video
cap = cv2.VideoCapture(1) #0 -> Webcam; "/path"
...
while True:
    ...
    cv2.putText(frame, str(round(fps,2)), (10, 50), font, 2, (0, 0, 0), 2) #FPS Value
    cv2.putText(frame, "FPS", (220, 50), font, 2, (0, 0, 0), 2) #FPS Label
